...
public final class Database {
	...
	private void addWithGenres(int year, String title, String artist, String mainGenre, String subGenre) {
		var genres = Arrays.stream(mainGenre.split(",")).map(String::trim).collect(Collectors.toSet());
		genres.stream().filter(s -> !this.genres.contains(s)).forEach(this.genres::add);
	...
	private void loadData() {
		...
		addWithGenres(1956, "Songs for Swingin' Lovers!", "Frank Sinatra", "Jazz, Pop", "Vocal, Easy Listening");
		addWithGenres(1957, "Here's Little Richard", "Little Richard", "Rock, Blues", "Rock & Roll, Rhythm & Blues");
		addWithGenres(1957, "The 'Chirping' Crickets", "The Crickets", "Rock, Pop", "Rockabilly, Rock & Roll");
		...
		addWithGenres(1959, "The Genius of Ray Charles", "Ray Charles", "Jazz, Pop", "Soul-Jazz, Big Band");
		...
		addWithGenres(1960, "Muddy Waters at Newport 1960", "Muddy Waters", "Rock, Blues", "Blues Rock, Chicago Blues");
		addWithGenres(1960, "Sketches of Spain", "Miles Davis", "Jazz", "Modal");
		addWithGenres(1961, "Two Steps From the Blues", "Bobby 'Blue' Bland", "Funk, Soul, Blues", "Rhythm & Blues, Soul");
		addWithGenres(1962, "Howlin' Wolf", "Howlin' Wolf", "Blues", "None");
		addWithGenres(1962, "Modern Sounds in Country and Western Music", "Ray Charles", "Funk, Soul, Folk, World, Country", "Country, Rhythm & Blues");
		addWithGenres(1963, "A Christmas Gift for You From Phil Spector", "Phil Spector", "Rock, Funk, Soul, Pop", "Pop Rock");
		addWithGenres(1963, "Live at the Apollo, 1962", "James Brown", "Funk, Soul", "Rhythm & Blues, Soul");
		addWithGenres(1963, "Please Please Me", "The Beatles", "Rock", "Beat, Rock & Roll");
		addWithGenres(1963, "Presenting the Fabulous Ronettes Featuring Veronica", "The Ronettes", "Rock, Pop", "Rock & Roll, Vocal");
		addWithGenres(1963, "The Freewheelin' Bob Dylan", "Bob Dylan", "Folk, World, Country", "Folk");
		addWithGenres(1964, "A Hard Day's Night", "The Beatles", "Rock, Stage & Screen", "Soundtrack, Beat, Pop Rock");
		addWithGenres(1964, "Folk Singer", "Muddy Waters", "Blues", "Delta Blues");
		addWithGenres(1964, "Getz / Gilberto", "Stan Getz/Joao GilbertofeaturingAntonio Carlos Jobim", "Jazz", "Bossa Nova,Latin Jazz");
		...
		addWithGenres(1965, "Bringing It All Back Home", "Bob Dylan", "Rock, Folk, World, Country", "Folk Rock, Folk");
		addWithGenres(1965, "Having a Rave Up", "The Yardbirds", "Rock", "Blues Rock, Psychedelic Rock");
		addWithGenres(1965, "Help!", "The Beatles", "Rock, Stage & Screen", "Beat, Soundtrack, Pop Rock");
		...
		addWithGenres(1965, "Mr. Tambourine Man", "The Byrds", "Rock", "Folk Rock, Garage Rock, Pop Rock");
		...
		addWithGenres(1965, "Out of Our Heads", "The Rolling Stones", "Rock", "Blues Rock, Rock & Roll");
		addWithGenres(1965, "Rubber Soul", "The Beatles", "Rock, Pop", "Pop Rock");
		addWithGenres(1965, "The Beach Boys Today!", "The Beach Boys", "Rock", "Pop Rock, Psychedelic Rock");
		addWithGenres(1965, "The Paul Butterfield Blues Band", "The Paul Butterfield Blues Band", "Rock, Blues", "Blues Rock, Electric Blues, Chicago Blues, Modern Electric Blues, Harmonica Blues");
		addWithGenres(1965, "The Rolling Stones, Now!", "The Rolling Stones", "Rock, Blues, Pop", "Pop Rock, Rhythm & Blues, Rock & Roll");
		...
		addWithGenres(1966, "Blonde on Blonde", "Bob Dylan", "Rock, Blues", "Folk Rock, Rhythm & Blues");
		addWithGenres(1966, "Complete & Unbelievable: The Otis Redding Dictionary of Soul", "Otis Redding", "Funk, Soul", "Soul");
		addWithGenres(1966, "Freak Out!", "The Mothers of Invention", "Electronic, Rock", "Musique Concr?te, Avantgarde, Symphonic Rock, Rhythm & Blues, Psychedelic Rock, Experimental, Parody");
		...
		addWithGenres(1966, "If You Can Believe Your Eyes and Ears", "The Mamas and the Papas", "Rock", "Folk Rock, Pop Rock");
		addWithGenres(1966, "Parsley, Sage, Rosemary and Thyme", "Simon & Garfunkel", "Rock, Pop, Folk, World, Country", "Folk Rock, Pop Rock");
		...
		addWithGenres(1966, "Roger the Engineer", "The Yardbirds", "Rock, Blues", "Blues Rock, Pop Rock");
		addWithGenres(1966, "The Beano Album", "John Mayall & The Bluesbreakers", "Rock,Blues", "Blues Rock,Electric Blues,Harmonica Blues");
		addWithGenres(1967, "Are You Experienced", "The Jimi Hendrix Experience", "Rock, Blues", "Blues Rock, Psychedelic Rock");
		addWithGenres(1967, "Axis: Bold as Love", "The Jimi Hendrix Experience", "Rock", "Psychedelic Rock, Electric Blues");
		addWithGenres(1967, "Between the Buttons", "The Rolling Stones", "Rock", "Blues Rock, Psychedelic Rock, Pop Rock");
		addWithGenres(1967, "Born Under a Bad Sign", "Albert King", "Funk, Soul, Blues", "Electric Blues, Rhythm & Blues, Soul");
		addWithGenres(1967, "Buffalo Springfield Again", "Buffalo Springfield", "Rock, Pop", "Country Rock");
		...
		addWithGenres(1967, "I Never Loved a Man the Way I Love You", "Aretha Franklin", "Funk, Soul", "Soul");
		...
		addWithGenres(1967, "Sgt. Pepper's Lonely Hearts Club Band", "The Beatles", "Rock", "Rock & Roll, Psychedelic Rock");
		addWithGenres(1967, "Something Else by The Kinks", "The Kinks", "Rock", "Pop Rock, Psychedelic Rock, Mod");
		addWithGenres(1967, "Strange Days", "The Doors", "Rock", "Psychedelic Rock");
		addWithGenres(1967, "Surrealistic Pillow", "Jefferson Airplane", "Rock", "Folk Rock, Psychedelic Rock");
		...
		addWithGenres(1967, "The Velvet Underground & Nico", "The Velvet Underground", "Rock", "Garage Rock, Art Rock, Experimental");
		addWithGenres(1967, "The Who Sell Out", "The Who", "Rock", "Psychedelic Rock, Mod");
		addWithGenres(1967, "Younger Than Yesterday", "The Byrds", "Rock", "Folk Rock, Psychedelic Rock");
		addWithGenres(1968, "Anthem of the Sun", "Grateful Dead", "Rock", "Psychedelic Rock");
		addWithGenres(1968, "Astral Weeks", "Van Morrison", "Jazz, Rock, Blues, Folk, World, Country", "Acoustic, Classic Rock, Free Improvisation");
		addWithGenres(1968, "At Folsom Prison", "Johnny Cash", "Folk, World, Country", "Country");
		addWithGenres(1968, "Beggars Banquet", "The Rolling Stones", "Rock, Funk, Soul, Pop", "Blues Rock, Southern Rock, Classic Rock");
		addWithGenres(1968, "Bookends", "Simon & Garfunkel", "Rock", "Folk Rock, Classic Rock");
		addWithGenres(1968, "Cheap Thrills", "Big Brother & the Holding Company", "Rock", "Folk Rock, Blues Rock, Psychedelic Rock");
		addWithGenres(1968, "Child Is Father to the Man", "Blood, Sweat & Tears", "Rock", "Blues Rock, Jazz-Rock, Classic Rock");
		addWithGenres(1968, "Electric Ladyland", "The Jimi Hendrix Experience", "Rock, Blues", "Electric Blues, Psychedelic Rock");
		addWithGenres(1968, "Gris-Gris", "Dr. John, the Night Tripper", "Jazz, Rock, Funk, Soul, Blues", "Soul-Jazz, Louisiana Blues, Fusion, Bayou Funk");
		addWithGenres(1968, "Lady Soul", "Aretha Franklin", "Funk, Soul", "Soul");
		addWithGenres(1968, "Music From Big Pink", "The Band", "Rock", "Folk Rock, Acoustic, Blues Rock");
		...
		addWithGenres(1968, "The Dock of the Bay", "Otis Redding", "Funk, Soul", "Rhythm & Blues, Soul");
		addWithGenres(1968, "The Drifters' Golden Hits", "The Drifters", "Rock, Funk, Soul", "Rhythm & Blues, Soul");
		addWithGenres(1968, "The Kinks Are The Village Green Preservation Society", "The Kinks", "Rock", "Psychedelic Rock, Pop Rock");
		addWithGenres(1968, "The Notorious Byrd Brothers", "The Byrds", "Rock", "Psychedelic Rock, Folk Rock, Country Rock, Pop Rock");
		addWithGenres(1968, "The White Album", "The Beatles", "Rock", "Rock & Roll, Pop Rock, Psychedelic Rock, Experimental");
		addWithGenres(1968, "We're Only in It for the Money", "The Mothers of Invention", "Electronic, Rock", "Modern Classical, Avantgarde, Psychedelic Rock, Experimental, Parody");
		addWithGenres(1968, "Wheels of Fire", "Cream", "Rock, Blues", "Blues Rock, Psychedelic Rock, Classic Rock");
		addWithGenres(1968, "White Light/White Heat", "The Velvet Underground", "Rock", "Avantgarde, Experimental");
		addWithGenres(1969, "Abbey Road", "The Beatles", "Rock", "Psychedelic Rock, Classic Rock, Pop Rock");
		addWithGenres(1969, "Boz Scaggs", "Boz Scaggs", "Rock", "Pop Rock");
		addWithGenres(1969, "Crosby, Stills & Nash", "Crosby, Stills & Nash", "Rock, Folk, World, Country", "Folk Rock, Classic Rock");
		addWithGenres(1969, "Dusty in Memphis", "Dusty Springfield", "Rock, Funk, Soul", "Pop Rock, Soul");
		addWithGenres(1969, "Everybody Knows This Is Nowhere", "Neil Young & Crazy Horse", "Rock", "Folk Rock, Country Rock, Classic Rock");
		addWithGenres(1969, "From Elvis in Memphis", "Elvis Presley", "Rock, Funk, Soul, Folk, World, Country", "Country, Soul");
		addWithGenres(1969, "Happy Trails", "Quicksilver Messenger Service", "Rock", "Acid Rock, Psychedelic Rock");
		addWithGenres(1969, "Kick Out the Jams", "MC5", "Rock", "Garage Rock, Hard Rock, Punk, Blues Rock");
		addWithGenres(1969, "Led Zeppelin II", "Led Zeppelin", "Rock", "Blues Rock, Classic Rock, Hard Rock");
		...
		addWithGenres(1969, "Live/Dead", "The Grateful Dead", "Rock", "Folk Rock, Country Rock, Psychedelic Rock, Experimental");
		addWithGenres(1969, "Santana", "Santana", "Rock, Latin, Funk, Soul", "Afro-Cuban, Psychedelic Rock");
		addWithGenres(1969, "Stand!", "Sly & The Family Stone", "Funk, Soul", "Funk, Psychedelic, Disco");
		addWithGenres(1969, "The Brown Album", "The Band", "Classical, Stage & Screen", "Soundtrack, Modern Classical, Contemporary, Score");
		addWithGenres(1969, "The Gilded Palace of Sin", "The Flying Burrito Brothers", "Rock, Folk, World, Country", "Country Rock");
		addWithGenres(1969, "The Stooges", "The Stooges", "Rock", "Garage Rock, Punk");
		addWithGenres(1969, "The Velvet Underground", "The Velvet Underground", "Rock", "Garage Rock, Art Rock, Experimental");
		addWithGenres(1969, "Tommy", "The Who", "Rock", "Psychedelic Rock");
		addWithGenres(1969, "Trout Mask Replica", "Captain Beefheart & His Magic Band", "Rock, Blues", "Dialogue, Field Recording, Avantgarde, Electric Blues, Psychedelic Rock, Experimental");
		addWithGenres(1969, "Volunteers", "Jefferson Airplane", "Rock", "Psychedelic Rock, Folk Rock, Country Rock, Honky Tonk");
		addWithGenres(1969, "Willy and the Poor Boys", "Creedence Clearwater Revival", "Rock", "Blues Rock, Rock & Roll, Classic Rock");
		...
		addWithGenres(1970, "Bridge Over Troubled Water", "Simon & Garfunkel", "Rock", "Folk Rock, Classic Rock");
		...
		addWithGenres(1970, "Greatest Hits", "Sly & The Family Stone", "Funk, Soul", "Rhythm & Blues, Funk");
		addWithGenres(1970, "John Lennon/Plastic Ono Band", "John Lennon / Plastic Ono Band", "Rock", "Pop Rock");
		addWithGenres(1970, "Layla and Other Assorted Love Songs", "Derek and the Dominos", "Rock", "Blues Rock");
		...
		addWithGenres(1970, "Moondance", "Van Morrison", "Jazz, Rock, Funk, Soul, Folk, World, Country", "Folk Rock, Rhythm & Blues, Classic Rock, Contemporary Jazz");
		addWithGenres(1970, "Paranoid", "Black Sabbath", "Rock", "Hard Rock, Heavy Metal");
		addWithGenres(1970, "Songs of Love and Hate", "Leonard Cohen", "Folk, World, Country", "Folk Rock, Folk, Ballad");
		addWithGenres(1970, "Sweet Baby James", "James Taylor", "Rock", "Folk Rock, Acoustic, Soft Rock");
		addWithGenres(1970, "Tea for the Tillerman", "Cat Stevens", "Rock, Stage & Screen", "Folk Rock, Pop Rock");
		addWithGenres(1970, "Tumbleweed Connection", "Elton John", "Rock, Folk, World, Country", "Soft Rock, Country Rock");
		addWithGenres(1970, "Workingman's Dead", "Grateful Dead", "Rock", "Folk Rock, Country Rock, Classic Rock");
		addWithGenres(1971, "Aqualung", "Jethro Tull", "Rock", "Classic Rock, Prog Rock");
		addWithGenres(1971, "At Fillmore East", "The Allman Brothers Band", "Rock, Blues", "Blues Rock");
		...
		addWithGenres(1971, "Maggot Brain", "Funkadelic", "Rock, Funk, Soul", "P.Funk, Psychedelic Rock");
		...
		addWithGenres(1971, "There's a Riot Goin' On", "Sly & The Family Stone", "Funk, Soul", "Rhythm & Blues, Funk");
		addWithGenres(1971, "What's Going On", "Marvin Gaye", "Funk, Soul", "Soul");
		addWithGenres(1971, "Who's Next", "The Who", "Rock", "Hard Rock, Mod, Prog Rock, Psychedelic Rock");
		addWithGenres(1971, "[Led Zeppelin IV]", "Led Zeppelin", "Rock", "Hard Rock, Classic Rock, Blues Rock");
		...
		addWithGenres(1972, "Dr. John's Gumbo", "Dr. John", "Funk, Soul", "Bayou Funk, Funk, Rhythm & Blues");
		addWithGenres(1972, "Eagles", "Eagles", "Rock", "Country Rock, Classic Rock");
		addWithGenres(1972, "Exile on Main St.", "The Rolling Stones", "Rock", "Blues Rock, Rock & Roll, Classic Rock");
		...
		addWithGenres(1972, "I'm Still in Love With You", "Al Green", "Funk, Soul", "Rhythm & Blues, Soul");
		addWithGenres(1972, "Music of My Mind", "Stevie Wonder", "Funk, Soul", "Soul-Jazz, Soul");
		addWithGenres(1972, "New Orleans Piano", "Professor Longhair", "Funk, Soul, Blues", "Piano Blues");
		addWithGenres(1972, "Paul Simon", "Paul Simon", "Rock", "Folk Rock, Pop Rock");
		addWithGenres(1972, "Pink Moon", "Nick Drake", "Rock, Folk, World, Country", "Folk, Folk Rock, Acoustic");
		addWithGenres(1972, "Sail Away", "Randy Newman", "Rock, Pop", "None");
		addWithGenres(1972, "Something/Anything?", "Todd Rundgren", "Rock", "Power Pop, Pop Rock, Prog Rock");
		addWithGenres(1972, "Superfly", "Curtis Mayfield", "Funk, Soul, Stage & Screen", "Soundtrack, Soul");
		addWithGenres(1972, "Talking Book", "Stevie Wonder", "Funk, Soul", "Soul, Funk");
		addWithGenres(1972, "The Harder They Come", "Various Artists", "Reggae,Pop,Folk, World, Country,Stage & Screen", "Reggae,Roots Reggae,Rocksteady,Contemporary,Soundtrack");
		addWithGenres(1972, "The Kink Kronikles", "The Kinks", "Rock", "Rock & Roll, Pop Rock");
		addWithGenres(1972, "The Rise and Fall of Ziggy Stardust and the Spiders From Mars", "David Bowie", "Rock", "Classic Rock, Glam");
		...
		addWithGenres(1973, "Funky Kingston", "Toots & The Maytals", "Reggae", "Reggae Gospel, Reggae, Roots Reggae, Rocksteady");
		addWithGenres(1973, "Goodbye Yellow Brick Road", "Elton John", "Rock", "Pop Rock, Classic Rock");
		...
		addWithGenres(1973, "Lynyrd Skynyrd", "Lynyrd Skynyrd", "Rock", "Blues Rock, Hard Rock, Southern Rock");
		...
		addWithGenres(1973, "Raw Power", "Iggy and The Stooges", "Rock", "Garage Rock, Hard Rock, Punk");
		addWithGenres(1973, "The Dark Side of the Moon", "Pink Floyd", "Rock", "Prog Rock");
		addWithGenres(1973, "The Wild, the Innocent & the E Street Shuffle", "Bruce Springsteen", "Rock", "None");
		...
		addWithGenres(1974, "Grievous Angel", "Gram Parsons", "Rock, Folk, World, Country", "Country Rock, Honky Tonk");
		addWithGenres(1974, "I Want to See the Bright Lights Tonight", "Richard & Linda Thompson", "Rock", "Classic Rock, Folk Rock");
		addWithGenres(1974, "Late for the Sky", "Jackson Browne", "Rock", "Pop Rock");
		addWithGenres(1974, "Natty Dread", "Bob Marley & The Wailers", "Reggae", "Reggae, Roots Reggae");
		addWithGenres(1974, "Nightbirds", "LaBelle", "Funk, Soul", "Funk, Disco");
		addWithGenres(1974, "Pretzel Logic", "Steely Dan", "Jazz, Rock", "Jazz-Rock, Pop Rock, Classic Rock");
		...
		addWithGenres(1974, "The Heart of Saturday Night", "Tom Waits", "Jazz, Pop, Folk, World, Country", "Contemporary Jazz, Spoken Word");
		...
		addWithGenres(1975, "Captain Fantastic and the Brown Dirt Cowboy", "Elton John", "Rock", "Pop Rock, Classic Rock");
		...
		addWithGenres(1975, "That's the Way of the World", "Earth, Wind & Fire", "Funk, Soul", "Soul, Funk, Disco");
		addWithGenres(1975, "The Basement Tapes", "Bob Dylan and the Band", "Rock", "Folk Rock, Country Rock, Classic Rock");
		addWithGenres(1975, "Tonight's the Night", "Neil Young", "Rock", "Blues Rock, Folk Rock, Classic Rock");
		...
		addWithGenres(1976, "Chronicle: The 20 Greatest Hits", "Creedence Clearwater Revival", "Rock", "None");
		...
		addWithGenres(1976, "Station to Station", "David Bowie", "Rock, Funk, Soul", "Classic Rock, Soul, Funk, Art Rock");
		...
		addWithGenres(1977, "Low", "David Bowie", "Electronic, Rock", "Art Rock, Ambient, Experimental");
		...
		addWithGenres(1977, "Never Mind the Bollocks Here's the Sex Pistols", "Sex Pistols", "Rock", "Punk");
		...
		addWithGenres(1977, "Saturday Night Fever: The Original Movie Sound Track", "Various Artists", "Electronic,Stage & Screen", "Soundtrack,Disco");
		...
		addWithGenres(1978, "52nd Street", "Billy Joel", "Jazz, Rock, Pop", "Pop Rock, Ballad, Latin Jazz");
		addWithGenres(1978, "Cheap Trick at Budokan", "Cheap Trick", "Rock", "Power Pop, Pop Rock, Arena Rock, Hard Rock");
		...
		addWithGenres(1978, "More Songs About Buildings and Food", "Talking Heads", "Rock", "New Wave, Indie Rock");
		addWithGenres(1978, "One Nation Under a Groove", "Funkadelic", "Funk, Soul", "P.Funk");
		addWithGenres(1978, "Outlandos d'Amour", "The Police", "Rock", "Alternative Rock, New Wave, Punk");
		addWithGenres(1978, "Parallel Lines", "Blondie", "Electronic, Rock", "New Wave, Pop Rock, Punk, Disco");
		addWithGenres(1978, "Q: Are We Not Men? A: We Are Devo!", "DEVO", "Rock", "New Wave");
		addWithGenres(1978, "Some Girls", "The Rolling Stones", "Rock", "Blues Rock, Rock & Roll, Classic Rock, Disco");
		addWithGenres(1978, "Stardust", "Willie Nelson", "Pop, Folk, World, Country", "Vocal");
		addWithGenres(1978, "The Cars", "The Cars", "Electronic, Rock", "New Wave, Pop Rock, Synth-pop");
		...
		addWithGenres(1979, "Armed Forces", "Elvis Costello & The Attractions", "Rock", "New Wave, Pop Rock");
		addWithGenres(1979, "Boys Don't Cry", "The Cure", "Rock", "New Wave, Post-Punk");
		addWithGenres(1979, "Damn the Torpedoes", "Tom Petty and the Heartbreakers", "Rock", "Soft Rock, Hard Rock, Pop Rock");
		...
		addWithGenres(1979, "Metal Box", "Public Image Ltd.", "Electronic, Rock", "Post-Punk, Dub, Avantgarde, Experimental");
		addWithGenres(1979, "Off the Wall", "Michael Jackson", "Funk, Soul, Pop", "Disco, Soul, Ballad");
		addWithGenres(1979, "Reggatta de Blanc", "The Police", "Rock, Pop", "New Wave, Pop Rock");
		addWithGenres(1979, "Rust Never Sleeps", "Neil Young & Crazy Horse", "Rock", "Hard Rock, Arena Rock");
		addWithGenres(1979, "Singles Going Steady", "Buzzcocks", "Rock", "Punk");
		addWithGenres(1979, "Squeezing Out Sparks", "Graham Parker & The Rumour", "Rock, Blues", "None");
		addWithGenres(1979, "The B 52's / Play Loud", "The B 52's", "Electronic, Rock, Pop", "New Wave, Punk, Mod");
		...
		addWithGenres(1980, "Remain in Light", "Talking Heads", "Electronic, Rock", "New Wave, Art Rock, Funk");
		addWithGenres(1980, "Sandinista!", "The Clash", "Rock, Reggae", "Rock & Roll, Dub, Punk");
		addWithGenres(1980, "The River", "Bruce Springsteen", "Rock", "Folk Rock, Pop Rock, Classic Rock");
		addWithGenres(1981, "Beauty and the Beat", "The Go Go's", "Rock", "Pop Rock");
		addWithGenres(1981, "Damaged", "Black Flag", "Rock", "Hardcore, Punk");
		addWithGenres(1981, "Ghost in the Machine", "The Police", "Rock, Pop", "Alternative Rock, New Wave, Pop Rock");
		...
		addWithGenres(1982, "Imperial Bedroom", "Elvis Costello & The Attractions", "Rock", "Alternative Rock, New Wave");
		addWithGenres(1982, "Nebraska", "Bruce Springsteen", "Rock", "Acoustic");
		addWithGenres(1982, "Shoot Out the Lights", "Richard & Linda Thompson", "Rock, Folk, World, Country", "Folk Rock");
		...
		addWithGenres(1983, "She's So Unusual", "Cyndi Lauper", "Electronic, Rock", "Pop Rock, Synth-pop");
		...
		addWithGenres(1984, "Double Nickels on the Dime", "Minutemen", "Rock", "Alternative Rock, Hardcore, Punk");
		addWithGenres(1984, "How Will the Wolf Survive?", "Los Lobos", "Rock, Latin", "Blues Rock");
		addWithGenres(1984, "Legend: The Best of Bob Marley and The Wailers", "Bob Marley & The Wailers", "Reggae", "Reggae, Roots Reggae");
		addWithGenres(1984, "Let It Be (The Replacements)", "The Replacements", "Rock", "Alternative Rock, Power Pop, Punk, Indie Rock");
		addWithGenres(1984, "Purple Rain", "Prince and the Revolution", "Electronic, Rock, Funk, Soul, Stage & Screen", "Pop Rock, Funk, Soundtrack, Synth-pop");
		addWithGenres(1984, "Run D.M.C.", "Run D.M.C.", "Hip Hop", "None");
		addWithGenres(1984, "Stop Making Sense", "Talking Heads", "Rock, Funk, Soul", "Funk, Indie Rock, New Wave");
		...
		addWithGenres(1985, "Rum Sodomy & the Lash", "The Pogues", "Rock, Folk, World, Country", "Folk Rock, Celtic, Punk");
		addWithGenres(1985, "The Indestructible Beat of Soweto", "Various Artists", "Funk, Soul,Folk, World, Country", "African");
		addWithGenres(1985, "Tim", "The Replacements", "Rock", "Indie Rock");
		addWithGenres(1985, "Whitney Houston", "Whitney Houston", "Funk, Soul, Pop", "Synth-pop, Rhythm & Blues");
		addWithGenres(1986, "Bo Diddley / Go Bo Diddley", "Bo Diddley", "Rock, Blues", "Rhythm & Blues, Rock & Roll");
		addWithGenres(1986, "Graceland", "Paul Simon", "Jazz, Rock, Funk, Soul, Pop, Folk, World, Country", "Folk Rock, Pop Rock, African, Afrobeat, Zydeco, Funk, Rhythm & Blues");
		addWithGenres(1986, "Guitar Town", "Steve Earle", "Rock, Folk, World, Country", "Country, Honky Tonk");
		...
		addWithGenres(1986, "So", "Peter Gabriel", "Electronic, Rock, Funk, Soul, Pop", "Art Rock, Pop Rock, Synth-pop, Funk");
		addWithGenres(1986, "The Queen Is Dead", "The Smiths", "Rock, Pop", "Indie Rock");
		addWithGenres(1987, "Appetite for Destruction", "Guns N' Roses", "Rock", "Hard Rock, Heavy §");
		addWithGenres(1987, "Bad", "Michael Jackson", "Funk, Soul, Pop", "Pop Rock, Ballad, Funk, Soul");
		addWithGenres(1987, "Document", "R.E.M.", "Rock", "None");
		addWithGenres(1987, "Faith", "George Michael", "Electronic, Rock, Funk, Soul, Blues, Pop", "Downtempo, Soft Rock, Pop Rock, Synth-pop");
		...
		addWithGenres(1988, "It Takes a Nation of Millions to Hold Us Back", "Public Enemy", "Hip Hop", "Conscious");
		...
		addWithGenres(1989, "Disintegration", "The Cure", "Electronic, Rock", "New Wave, Alternative Rock");
		addWithGenres(1989, "Doolittle", "Pixies", "Rock", "Indie Rock");
		addWithGenres(1989, "I Do Not Want What I Haven't Got", "Sinead O'Connor", "Rock, Funk, Soul, Blues", "Blues Rock, Rhythm & Blues, Soul");
		...
		addWithGenres(1989, "Paul's Boutique", "Beastie Boys", "Hip Hop, Rock, Funk, Soul", "Alternative Rock, Pop Rap, Psychedelic");
		addWithGenres(1989, "Rhythm Nation 1814", "Janet Jackson", "Electronic, Hip Hop, Pop", "RnB/Swing, Downtempo, Synth-pop");
		...
		addWithGenres(1990, "The Best of the Girl Groups, Volume 1", "Various Artists", "Rock,Pop", "Pop Rock, Vocal");
		...
		addWithGenres(1991, "Achtung Baby", "U2", "Electronic, Rock", "Pop Rock, Synth-pop, Alternative Rock, Arena Rock");
		addWithGenres(1991, "Back to Mono (1958-1969)", "Phil Spector", "Rock, Funk, Soul, Pop", "Doo Wop, Pop Rock, Ballad, Rhythm & Blues");
		addWithGenres(1991, "Blood Sugar Sex Magik", "Red Hot Chili Peppers", "Rock", "Alternative Rock, Funk Metal");
		...
		addWithGenres(1991, "Proud Mary: The Best of Ike and Tina Turner", "Ike & Tina Turner", "Funk, Soul", "Rhythm & Blues, Bayou Funk, Soul");
		addWithGenres(1991, "Star Time", "James Brown", "Funk, Soul", "Soul, Funk, Disco");
		addWithGenres(1991, "Ten", "Pearl Jam", "Rock", "Grunge");
		addWithGenres(1991, "The Birth of Soul", "Ray Charles", "Jazz, Funk, Soul", "Rhythm & Blues, Big Band, Soul, Soul-Jazz");
		addWithGenres(1991, "The Low End Theory", "A Tribe Called Quest", "Hip Hop", "Conscious");
		addWithGenres(1991, "The Ultimate Collection: 1948-1990", "John Lee Hooker", "Blues", "Country Blues, Electric Blues, Chicago Blues, Jump Blues");
		...
		addWithGenres(1992, "Rage Against the Machine", "Rage Against the Machine", "Hip Hop, Rock", "Funk Metal");
		addWithGenres(1992, "Slanted and Enchanted", "Pavement", "Rock", "Alternative Rock");
		addWithGenres(1992, "The Anthology: 1961-1977", "Curtis Mayfield and The Impressions", "Funk, Soul", "Rhythm & Blues, Soul, Funk");
		addWithGenres(1992, "The Chronic", "Dr. Dre", "Hip Hop", "Gangsta");
		addWithGenres(1993, "All Killer No Filler! The Jerry Lee Lewis Anthology", "Jerry Lee Lewis", "Rock, Blues, Folk, World, Country", "Country Blues, Rock & Roll, Rhythm & Blues");
		...
		addWithGenres(1994, "American Recordings", "Johnny Cash", "Folk, World, Country", "Country, Gospel, Folk");
		addWithGenres(1994, "CrazySexyCool", "TLC", "Electronic, Hip Hop, Funk, Soul", "RnB/Swing");
		addWithGenres(1994, "Crooked Rain Crooked Rain", "Pavement", "Rock", "Alternative Rock, Indie Rock");
		...
		addWithGenres(1994, "MTV Unplugged in New York", "Nirvana", "Rock", "Folk Rock, Acoustic, Grunge");
		...
		addWithGenres(1994, "The Sun Records Collection", "Various", "Rock, Funk, Soul, Blues, Pop, Folk, World, Country", "Country Blues, Rock & Roll, Rockabilly");
		...
		addWithGenres(1995, "Anthology: The Best of The Temptations", "The Temptations", "Electronic, Funk, Soul", "Soul, Disco");
		...
		addWithGenres(1996, "Odelay", "Beck", "Electronic, Hip Hop, Funk, Soul, Pop", "Electro, Downtempo, Hip Hop, Disco, Afrobeat, Abstract");
		addWithGenres(1996, "Reasonable Doubt", "Jay Z", "Hip Hop", "None");
		addWithGenres(1996, "The Score", "Fugees", "Hip Hop", "Pop Rap, Conscious");
		addWithGenres(1997, "Anthology of American Folk Music", "Various", "Blues, Folk, World, Country", "Cajun, Country, Field Recording, Gospel, Delta Blues, Folk");
		...
		addWithGenres(1997, "The Velvet Rope", "Janet", "Electronic, Funk, Soul, Pop", "RnB/Swing, Downtempo");
		...
		addWithGenres(1998, "Car Wheels on a Gravel Road", "Lucinda Williams", "Folk, World, Country", "Country, Folk");
		addWithGenres(1998, "Nuggets: Original Artyfacts From the First Psychedelic Era, 1965-1968", "Various Artists", "Rock", "Garage Rock,Psychedelic Rock");
		addWithGenres(1998, "Ray of Light", "Madonna", "Electronic, Pop", "House, Techno, Downtempo, Vocal, Ambient");
		addWithGenres(1998, "The Miseducation of Lauryn Hill", "Lauryn Hill", "Hip Hop", "RnB/Swing, Conscious");
		addWithGenres(1999, "69 Love Songs", "The Magnetic Fields", "Electronic, Rock", "Synth-pop, Indie Rock");
		addWithGenres(1999, "Californication", "Red Hot Chili Peppers", "Rock", "Alternative Rock, Funk Metal");
		...
		addWithGenres(1999, "The Neil Diamond Collection", "Neil Diamond", "Rock, Pop", "Soft Rock, Ballad");
		...
		addWithGenres(2000, "Kid A", "Radiohead", "Electronic, Rock", "Alternative Rock, IDM, Experimental");
		addWithGenres(2000, "Stankonia", "OutKast", "Hip Hop, Funk, Soul", "Gangsta, P.Funk, Crunk, Conscious");
		addWithGenres(2000, "Stories From the City, Stories From the Sea", "PJ Harvey", "Rock", "Indie Rock");
		addWithGenres(2000, "The Marshall Mathers LP", "Eminem", "Hip Hop", "Pop Rap, Hardcore Hip-Hop, Horrorcore");
		...
		addWithGenres(2001, "Amnesiac", "Radiohead", "Electronic, Rock", "Alternative Rock, Experimental");
		addWithGenres(2001, "Anthology", "Diana Ross & The Supremes", "Electronic, Funk, Soul", "Pop Rock, Soul, Disco");
		...
		addWithGenres(2001, "Proxima estacion: Esperanza", "Manu Chao", "Rock, Reggae, Latin", "Folk Rock, Reggae, Reggae-Pop");
		addWithGenres(2001, "The Anthology", "Muddy Waters", "Folk, World, Country", "Folk");
		addWithGenres(2001, "The Blueprint", "Jay Z", "Hip Hop", "None");
		addWithGenres(2001, "The Definitive Collection", "ABBA", "Electronic, Pop", "Europop, Synth-pop, Disco");
		addWithGenres(2001, "White Blood Cells", "The White Stripes", "Rock", "Indie Rock, Alternative Rock, Blues Rock, Garage Rock");
		addWithGenres(2002, "A Rush of Blood to the Head", "Coldplay", "Rock", "Alternative Rock, Pop Rock");
		addWithGenres(2002, "All Time Greatest Hits", "Loretta Lynn", "Folk, World, Country", "Country");
		addWithGenres(2002, "Sea Change", "Beck", "Rock", "Alternative Rock, Post Rock");
		addWithGenres(2002, "Sleepless", "Peter Wolf", "Rock, Blues, Pop", "Blues Rock, Pop Rock, Ballad");
		addWithGenres(2002, "The Rising", "Bruce Springsteen", "Rock", "Folk Rock, Classic Rock");
		addWithGenres(2002, "The Very Best of Linda Ronstadt", "Linda Ronstadt", "Rock, Pop", "Soft Rock, Pop Rock");
		addWithGenres(2002, "Yankee Hotel Foxtrot", "Wilco", "Rock", "Alternative Rock");
		addWithGenres(2003, "Elephant", "The White Stripes", "Rock", "Blues Rock, Garage Rock, Alternative Rock");
		addWithGenres(2003, "Portrait of a Legend 1951-1964", "Sam Cooke", "Latin, Funk, Soul", "Soul, Rhythm & Blues, Gospel, Cha-Cha");
		addWithGenres(2003, "The Black Album", "Jay Z", "Hip Hop", "None");
		addWithGenres(2003, "The College Dropout", "Kanye West", "Hip Hop", "Pop Rap, Conscious, Contemporary R&B");
		...
		addWithGenres(2006, "Whatever People Say I Am, That's What I'm Not", "Arctic Monkeys", "Rock", "Indie Rock");
		addWithGenres(2007, "In Rainbows", "Radiohead", "Electronic, Rock", "Alternative Rock, Art Rock");
		addWithGenres(2007, "Kala", "M.I.A.", "Electronic, Hip Hop, Reggae, Pop", "Grime, Bollywood, Hip Hop, Dancehall");
		addWithGenres(2007, "Oracular Spectacular", "MGMT", "Electronic, Rock, Pop", "Synth-pop, Indie Rock");
		addWithGenres(2007, "Sound of Silver", "LCD Soundsystem", "Electronic, Rock", "Leftfield, Alternative Rock, Electro, Disco");
		addWithGenres(2007, "Vampire Weekend", "Vampire Weekend", "Rock", "Indie Rock");
		addWithGenres(2008, "Tha Carter III", "Lil Wayne", "Hip Hop, Funk, Soul", "RnB/Swing, Screw, Pop Rap, Thug Rap");
		addWithGenres(2010, "My Beautiful Dark Twisted Fantasy", "Kanye West", "Hip Hop", "None");
		addWithGenres(2011, "The Smile Sessions", "The Beach Boys", "Rock", "Pop Rock, Psychedelic Rock");
		addWithGenres(2018, "Street Worms", "Viagra Boys", "Rock", "Post-Punk");
		addWithGenres(2021, "Welfare Jazz", "Viagra Boys", "Rock", "Post-Punk");
		addWithGenres(2022, "Cave World", "Viagra Boys", "Rock", "Post-Punk");
		addWithGenres(2024, "TANGK", "IDLES", "Rock", "Post-Punk");
	}
}
